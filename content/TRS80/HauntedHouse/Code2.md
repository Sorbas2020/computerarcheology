...
436B: 21 69 4E        LD      HL,$4E69            ; YOU_DROP_EVERYTHING_YOU_HAD_TO_CLIMB_THE_ROPE.__YOU_REACH_THE___SECOND_FLOOR.
...
4452: 21 5A 4E        LD      HL,$4E5A            ; I_DON'T_UNDERSTAND.
...
44AB: 21 1F 4E        LD      HL,$4E1F            ; YOU_AREN'T_CARRYING_IT.
44AE: C3 B4 44        JP      $44B4               ; {} Print and out
44B1: 21 31 4E        LD      HL,$4E31            ; THERE'S_NOT_ONE_HERE.
...
44CB: 21 41 4E        LD      HL,$4E41            ; WHAT_SHOULD_I_DO_WITH_IT?
...
4782: E6 4B A2 47 ; RM_01_HOLE_IN_FLOOR              PS_08
4786: DA 4B B5 47 ; RM_02_DIMLY_LIT_ROOM1            PS_07
478A: DA 4B EF 47 ; RM_03_DIMLY_LIT_ROOM2            PS_07
478E: DA 4B 29 48 ; RM_04_DIMLY_LIT_ROOM3            PS_07
4792: DA 4B 67 48 ; RM_05_DIMLY_LIT_ROOM4            PS_07
4796: DA 4B A0 48 ; RM_06_DIMLY_LIT_ROOM5            PS_07
479A: DA 4B B9 48 ; RM_07_DIMLY_LIT_ROOM6            PS_07
479E: DA 4B CE 48 ; RM_08_DIMLY_LIT_ROOM7            PS_07
```
...
4915: 00 02 ; 000..... OBJ_01_GHOST1            RM_02_DIMLY_LIT_ROOM1
4917: 00 03 ; 000..... OBJ_02_GHOST2            RM_03_DIMLY_LIT_ROOM2
4919: 00 04 ; 000..... OBJ_03_GHOST3            RM_04_DIMLY_LIT_ROOM3
491B: 00 05 ; 000..... OBJ_04_GHOST4            RM_05_DIMLY_LIT_ROOM4
491D: 00 00 ; 000..... OBJ_05_GHOST5            *
491F: 00 00 ; 000..... OBJ_06_GHOST6            *
4921: 00 00 ; 000..... OBJ_07_GHOST7            *
4923: 00 00 ; 000..... OBJ_08_GHOST8            *
4925: 40 01 ; 010..... OBJ_09_SWORD             RM_01_HOLE_IN_FLOOR
4927: 40 08 ; 010..... OBJ_0A_SIGN              RM_08_DIMLY_LIT_ROOM7
4929: 00 06 ; 000..... OBJ_0B_GHOST9            RM_06_DIMLY_LIT_ROOM5
492B: 00 07 ; 000..... OBJ_0C_GHOST10           RM_07_DIMLY_LIT_ROOM6
; ?? Why is this pick-up-able?
492D: 40 00 ; 010..... OBJ_0D_EXIT_MARKER       *
...
```code
ScriptCommands:
494D: 6E 49        ; COM_01_move_look(room_num)
494F: B6 49        ; COM_02_is_in_pack(obj_num)
4951: C5 49        ; COM_03_is_in_pack_or_current_room(obj_num)
4953: FE 49        ; COM_04_print(ps_num)
4955: 76 49        ; COM_05_print_room_description()
4957: 22 44        ; COM_06_stop_if_pass()
4959: 97 4A        ; COM_07_end_of_game()
495B: 0B 4A        ; COM_08_drop_object_print_ok(obj_num)
495D: 1A 4A        ; COM_09_print_inventory()
495F: 44 4A        ; COM_0A_is_object_user_input(obj_num)
4961: 52 4A        ; COM_0B_get_from_room_print_ok(obj_num)
4963: 79 4A        ; COM_0C_print_ok()
4965: 82 4A        ; COM_0D_move_object_to_room(obj_num, room_num)
4967: E9 49        ; COM_0E_get_users_object_print_ok()
4969: 72 4A        ; COM_0F_drop_users_object_print_ok()
496B: D8 49        ; COM_10_is_in_current_room(obj_num)

; This is good evidence that HauntedHouse is a cleaned Pyramid. The first floor of HH has cleaned this out, but
; the 2nd floor didn't.
...
# COM_10_is_in_current_room(obj_num)

```code
COM_10_is_in_current_room:
...
# COM_0E_get_users_object_print_ok()
...
49F4: C3 79 4A        JP      $4A79               ; {code.COM_0C_print_ok} Print OK and PASS
;
...
# COM_08_drop_object_print_ok(obj_num)

```code
COM_08_drop_object_print_ok:
...
4A17: C3 79 4A        JP      $4A79               ; {code.COM_0C_print_ok} Print OK and PASS
```

# COM_09_print_inventory()
...
# COM_0A_is_object_user_input(obj_num)

```code
COM_0A_is_object_user_input:
...
# COM_0B_get_from_room_print_ok(obj_num)

```code
COM_0B_get_from_room_print_ok:
...
4A6F: C3 79 4A        JP      $4A79               ; {code.COM_0C_print_ok} Print OK and PASS
```

# COM_0F_drop_users_object_print_ok()
...
# COM_0D_move_object_to_room(obj_num, room_num)

```code
COM_0D_move_object_to_room:
...
```code
COM_07_end_of_game:
4A97: C3 97 4A        JP      $4A97               ; {code.COM_07_end_of_game} Infinite loop
```
...
4AA0: 0C 53 57 4F 52                         09 ; 00_001_100  SWOR
4AA6: 3C 47 48 4F 53       01 02 03 04 05 06 07 ; 00_111_100  GHOS
;
; Verbs
4AB2: C9 4E                                  01 ; 11_001_001  N
4AB5: C9 45                                  02 ; 11_001_001  E
4AB8: C9 53                                  03 ; 11_001_001  S
4ABB: C9 57                                  04 ; 11_001_001  W
4ABE: CC 43 4C 49 4D                         0F ; 11_001_100  CLIM
4AC4: CC 4A 55 4D 50                         0F ; 11_001_100  JUMP
4ACA: CC 51 55 49 54                         0B ; 11_001_100  QUIT
4AD0: CC 49 4E 56 45                         0C ; 11_001_100  INVE
4AD6: CC 4C 4F 4F 4B                         0D ; 11_001_100  LOOK
4ADC: 4C 44 52 4F 50                         07 ; 01_001_100  DROP
4AE2: 8B 47 45 54                            06 ; 10_001_011  GET
4AE7: 8C 4F 50 45 4E                         05 ; 10_001_100  OPEN
4AED: 8C 53 4D 41 53                         11 ; 10_001_100  SMAS
4AF3: CB 48 49 54                            11 ; 11_001_011  HIT
4AF8: CC 41 54 54 41                         11 ; 11_001_100  ATTA
4AFE: CC 4B 49 4C 4C                         11 ; 11_001_100  KILL
4B04: CB 59 45 53                            12 ; 11_001_011  YES
4B09: CA 4E 4F                               13 ; 11_001_010  NO
4B0D: 4C 52 45 41 44                         09 ; 01_001_100  READ
4B13: CC 50 4C 55 47                         0A ; 11_001_100  PLUG
4B19: 00
```
...
; THERE_IS_A_RUSTY_OLD_SIGN_LAYING_ON_THE_GROUND.
PS_04:
...
; DIMLY_LIT_ROOM.
PS_07: ; RM_02_DIMLY_LIT_ROOM1, RM_03, RM_04, RM_05, RM_06, RM_07, RM_08
4BDA: 05 8F 5A FB 8E 96 8C 39 17 FF 9F 00

; DIMLY_LIT_ROOM.__THERE_IS_A_HOLE_IN_THE_FLOOR.
PS_08: ; RM_01_HOLE_IN_FLOOR
...
; YOUR_MAGIC_SWORD_ENABLES_YOU_TO_KILL_THE_GHOST!
PS_0B:
...
; THE_GHOST_IS_IMMUNE_TO_YOUR_ATTACK!
PS_12:
4CBF: 0B 5F BE 7A 15 E6 A0 D5 15 CF 15 B0 94 56 5E DB
4CCF: 9C 34 A1 96 14 45 BD 4B 21 00

; THE_SIGN_SAYS,__________________________________________________
...
; YOU_FALL_THROUGH_A_TRAP_DOOR_TO_YOUR_DEATH!
PS_14:
4D56: 0E C7 DE 4B 15 F3 8C 6C BE 29 A1 03 71 8C 17 D3
4D66: 48 81 5B 96 AF DB 9C 34 A1 FF 14 82 49 21 00

; YOU_WALK_THROUGH_A_DOOR_AND_FIND_YOURSELF_ON_A_BALCONY.__YOU____
...
; AN_INSCRIPTION_READS,_"GHOST_KILLER."
PS_16:
...
; YOU_FALL_THROUGH_THE_HOLE_AND_BREAK_YOUR_NECK.__YOU_ARE_DEAD.
PS_18:
...
; WHAT_DO_YOU_WANT_ME_TO_DO_WITH_IT?
PS_1B:
...
; YOU_DROP_EVERYTHING_YOU_HAD_TO_CLIMB_THE_ROPE.__YOU_REACH_THE___
; SECOND_FLOOR.
PS_1D:
