...
ObjectDescriptions:
;             Name                        Desc
48E3: 35 4B ; OBJ_01_PAPER                PS_00
48E5: 64 4B ; OBJ_02_DOOR                 PS_02
48E7: 77 4B ; OBJ_03_KEY                  PS_03
48E9: 87 4B ; OBJ_04_FIRE                 PS_05
48EB: A5 4B ; OBJ_05_LOCKED_DOOR          PS_06
48ED: BD 4B ; OBJ_06_KNIFE                PS_08
48EF: E5 4B ; OBJ_07_ROPE                 PS_0A
48F1: CB 47 ; OBJ_08_ARMOR        Empty string (no description for the suit of armor)
48F3: F8 4B ; OBJ_09_CABINET              PS_0B
48F5: 0F 4C ; OBJ_0A_BUCKET               PS_0C
48F7: F8 4B ; OBJ_0B_KEY_IN_CABINET       PS_0B
48F9: 32 4C ; OBJ_0C_ROPE_CEILING         PS_0E
48FB: 5F 4C ; OBJ_0D_SCROLL               PS_0F
```
...
```code
ScriptCommands:
48FD: 1F 49        ; COM_01_move_look(room_num)
48FF: 67 49        ; COM_02_is_in_pack(obj_num)
4901: 76 49        ; COM_03_is_in_pack_or_current_room(obj_num)
4903: AF 49        ; COM_04_print(ps_num)
4905: 27 49        ; COM_05_print_room_description()
4907: 22 44        ; COM_06_stop_if_pass()
4909: 48 4A        ; COM_07_end_of_game()
490B: BC 49        ; COM_08_drop_object_print_ok(obj_num)
490D: CB 49        ; COM_09_print_inventory()
490F: F5 49        ; COM_0A_is_object_user_input(obj_num)
4911: 03 4A        ; COM_0B_get_from_room_print_ok(obj_num)
4913: 2A 4A        ; COM_0C_print_ok()
4915: 33 4A        ; COM_0D_move_object_to_room(obj_num, room_num)
4917: 9A 49        ; COM_0E_get_users_object_print_ok()
4919: 23 4A        ; COM_0F_drop_users_object_print_ok()
491B: 89 49        ; COM_10_is_in_current_room(obj_num)
491D: F5 42        ; COM_11_load_second_floor()
```
...
49A5: C3 2A 4A        JP      $4A2A               ; {code.COM_0C_print_ok} Print OK and PASS
;
...
49C8: C3 2A 4A        JP      $4A2A               ; {code.COM_0C_print_ok} Print OK and PASS
```
...
4A20: C3 2A 4A        JP      $4A2A               ; {code.COM_0C_print_ok} Print OK and PASS
```
...
```code
COM_07_end_of_game:
4A48: C3 48 4A        JP      $4A48               ; {code.COM_07_end_of_game} Infinite loop
```
